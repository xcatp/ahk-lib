...
SliderObj.OnEvent("Change", (*) => Slider_Change(PictureObj, SliderObj.Value))
...
Slider_Change(GuiCtrlObj, value) {
	Gdip_SetProgress(&GuiCtrlObj, value, 0xff0993ea, 0xffbde5ff, value . '%')
}
